...
package roshan.dhimal.audioclient;
...
import roshan.dhimal.clipserver.IMyAidlInterface;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Intent startIntent(){
        ...
        intent.setPackage("roshan.dhimal.clipserver");
        return intent;
    }
    @Override
        ...
        startService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    e.printStackTrace();
                    status.setText("Failed to start service");
...
//        }
    ...
    public void onClickPlay(String name) throws RemoteException {
        if (binder != null) {
            ...
            status.setText("Service not bound. Cannot play song.");
        }
    }
}